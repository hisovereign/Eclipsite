...
class EclipsiteApplet extends Applet.IconApplet {
    constructor(metadata, orientation, panelHeight, instanceId) {
        super(orientation, panelHeight, instanceId);

        this.set_applet_icon_symbolic_name("audio-card");
        this.set_applet_tooltip("Eclipsite - Per-app volume control");
...
function main(metadata, orientation, panelHeight, instanceId) {
    return new EclipsiteApplet(metadata, orientation, panelHeight, instanceId);
}
